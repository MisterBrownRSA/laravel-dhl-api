<?php
    ...
    class GetQuote extends APIAbstract
    {
        ...
        public function toXML()
        {
            ...
            $xml->writeElement('MessageReference', $this->reference); //"1234567890123456789012345678901"
...
//                        $xml->writeElement('Suburb', 'Klerksdorp'); //
//                        $xml->writeElement('VatNo', 'Klerksdorp'); //
            $xml->endElement();
...
//                        $xml->writeElement('ReadyTimeGMTOffset', '+02:00'); //#Optional
...
//            $xml->writeElement('SpecialServiceType', 'WY');
        ...
        {
            $this->toCity($user->addresses()->primary()->town)
